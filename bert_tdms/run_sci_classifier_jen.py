...
# !python run_sci_classifier.py --use_tpu=True --tpu=grpc://10.68.220.162:8470 --do_train=True --do_eval=False
# --do_predict=False --task_name=sci --data_dir=/content/gdrive/My\ Drive/paperswithcodedatawith600unk/twofold/fold2
# --output_dir=$OUTPUT_DIR --model_dir=$OUTPUT_DIR --uncased=False
# --model_config_path=../xlnet_large_cased/xlnet_config.json --spiece_model_file=../xlnet_large_cased/spiece.model
# --init_checkpoint=$BUCKET_NAME/xlnet_large_cased/xlnet_model.ckpt --max_seq_length=512
# --train_batch_size=16 --num_hosts=1 --num_core_per_host=8 --learning_rate=1e-5 --train_steps=50000
# --warmup_steps=500 --save_steps=500 --iterations=1000
